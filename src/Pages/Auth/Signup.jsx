  ...
  return (
    <div className="inline-flex flex-col sm:w-full lg:w-1/2">
      ...
      <input
        ...
        onChange={onChange}
        className="w-[350px] px-6 h-[50px] rounded-[10px] border-2 border-neutral-400 placeholder:text-stone-400 placeholder:text-lg font-medium"
      />
      ...
      <div className="flex flex-col justify-center items-center align-middle mt-10">
        <div>
          ...
          <p className="text-center text-stone-400 text-lg font-medium py-6">
            Join BloodSavers help save lives
          </p>
          <form
            action=""
            ...
            <div>
              <label htmlFor="profile">
                <div className="inline-flex gap-2 items-center justify-center cursor-pointer">
                  <span className="text-[30px] text-red-800">📷</span>
